 ...
 * Use the {@link role_selection#newInstance} factory method to
 * create an instance of this fragment.
 */
public class role_selection extends Fragment {
     ...
     * @return A new instance of fragment role_selection.
     */
    // TODO: Rename and change types and number of parameters
    public static role_selection newInstance(String param1, String param2) {
        role_selection fragment = new role_selection();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn_faculty.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                loadFragment(new faculty_login());
        ...
        btn_student.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                loadFragment(new student_login());
            }
        });
